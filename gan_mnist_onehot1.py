...
with tf.Session(config=config) as session:
    ...
    for iteration in xrange(ITERS):
        ...
        if iteration%100==99:
            ...
            im0,im1,im2,im3,im3,im4,im5,im6,im7,im8,im9 = session.run([f0,f1,f2,f3,f4,f5,f6,f7,f8,f9],feed_dict={real_data:_data,real_label:_label,ind_t:np.array(num_index)})
