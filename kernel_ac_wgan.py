    ...
    with tf.Session(config=config) as sess:
        ...
        for i in xrange(FLAGS.iter_range):
            ...
            for x in xrange(FLAGS.disc_inter):
                _disc,_class_real,_class_fake,_,con_cost,_kernel= sess.run([disc_cost,class_loss_real,class_loss_fake,disc_train,con_kernel_cost,kernel_cost],feed_dict={X_image:data_x,y_label_index:data_y,ind_t:np.array(num_index)})
            if i>0:
            ...
            if i%100==99:
                ...
                save_images.save_images(image.reshape((128,28,28)),"./a_gen_image_{}.png".format(i))
